...
" Colorizer Options
let g:colorizer_auto_filetype='css,html,typescript.tsx,javascript'
...
" Navigating git
nmap <silent>gh <Plug>(GitGutterNextHunk)
nmap <silent>g<S-H> <Plug>(GitGutterPrevHunk)
...
nmap <silent> gF <c-w>f<c-w>L
nmap <silent> gD :sp<enter><c-w>L<Plug>(coc-definition)
nmap <silent> gY :sp<enter><c-w>L<Plug>(coc-type-definition)
nmap <silent> gY :sp<enter><c-w>L<Plug>(coc-implementation)

" Navigating quickList
nmap <silent>gn :cn<CR>
nmap <silent>g<S-N> :cp<CR>
